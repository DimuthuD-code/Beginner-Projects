...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/teachers">Teachers Management</a></li>
...
<div class="row mt-4">
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('teachers.edit_validation') }}" method="post">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        <label for=""><b>Teacher Email</b></label>
    ...
    $(document).ready(function(){
        $('.dynamic').change(function(){
            if($(this).val() != '')
            {
                ...
                $.ajax({
                    url: "{{ route('teachers.getdistrict') }}",
                    method:"POST",
